...
const MainCourse = ({ course }: Props) => {
  return (
    <section className="mb-24 flex flex-col items-center justify-center gap-10 text-center xl:flex-row xl:items-start xl:text-start">
      <div className="w-full max-w-[500px] md:max-w-[700px]">
        <div className="flex flex-row items-center justify-center gap-3 xl:justify-start">
          <FontAwesomeIcon
            className="h-5 w-5"
            icon={faGlobe}
          />
      ...
      <div className="relative mt-6 xl:mt-0">
        <Image
          className="h-full max-h-[500px] w-[230px] rotate-12 rounded-[30px] object-cover sm:w-[300px]"
          src={course?.imageUrl ? course.imageUrl : ""}
          alt="img"
          width={400}
          height={500}
        />
        <div className="absolute -top-5 -z-10 h-full max-h-[500px] w-[230px] rounded-[32px] bg-primary opacity-10 blur-lg sm:w-[300px]"></div>
      </div>
    </section>
  )
}
