    ...
    return (
        <Card className="w-full max-w-[600px] shadow-md dark:border-none">
            ...
            <CardContent className="flex flex-col gap-4">
                ...
                <UserInfoItem title="Two factor enabled" text={user?.isTwoFactorEnabled} />
...
const UserInfoItem = ({ title, text }: UserInfoItemProps) => {
    return <div className="mobile:flex-row flex w-full flex-col items-center justify-between rounded-xl border border-border p-4">
        <p>{title}</p>
