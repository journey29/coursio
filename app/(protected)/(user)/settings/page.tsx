...
const Settings = () => {
    ...
    return (
        <Card className="max-w-[600px] w-full shadow-md dark:border-none">
                        ...
                        {!user?.isOAuth && (
                            <>
                                ...
                                <FormField
                                    ...
                                    render={({ field }) => (
                                        <FormItem className="dark:border- flex flex-row items-center justify-between rounded-lg border border-border p-3 shadow-sm">
